...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-[var(--text-size-sm)] font-medium group-data-[size=sm]/card:text-[var(--text-size-sm)]",
        className,
      )}
      {...props}
    />
